...
func (api *API) LoadProject(ctx context.Context, configFileName string) (*ProjectResponse, error) {
	project, _, release, err := api.session.OpenProject(ctx, api.toAbsoluteFileName(configFileName))
	if release != nil {
		defer release()
	}
	if err != nil {
...
func (api *API) GetSymbolAtPosition(ctx context.Context, projectId Handle[project.Project], fileName string, position int) (*SymbolResponse, error) {
	...
	languageService := ls.NewLanguageService(project.GetProgram(), snapshot, fileName)
...
func (api *API) GetSymbolAtLocation(ctx context.Context, projectId Handle[project.Project], location Handle[ast.Node]) (*SymbolResponse, error) {
	...
	languageService := ls.NewLanguageService(project.GetProgram(), snapshot, sourceFile.FileName())
...
func (api *API) GetDiagnostics(ctx context.Context, projectId Handle[project.Project], fileNames []string) ([]*ls.Diagnostic, error) {
	...
	languageService := ls.NewLanguageService(project.GetProgram(), snapshot, activeFile)
